...
<template>
    <div class="w-full h-screen overflow-hidden pl-4 pr-4">
        ...
        <div class="overflow-y-scroll h-full pb-72">
            <h2 class="text-4xl pb-4 flex justify-between">Monthly Wallpapers <span>{{ time.year }}-{{ time.getMonth() }}</span> </h2>
